...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { contact_id: @opportunity.contact_id, organization_id: @opportunity.organization_id, progress: @opportunity.progress, status: @opportunity.status }
    end
  ...
  test "should update opportunity" do
    put :update, id: @opportunity, opportunity: { contact_id: @opportunity.contact_id, organization_id: @opportunity.organization_id, progress: @opportunity.progress, status: @opportunity.status }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
