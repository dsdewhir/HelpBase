...
class InvoiceitemsControllerTest < ActionController::TestCase
  ...
  test "should create invoiceitem" do
    assert_difference('Invoiceitem.count') do
      post :create, invoiceitem: { amount: @invoiceitem.amount, description: @invoiceitem.description, invoice_id: @invoiceitem.invoice_id, subscription_id: @invoiceitem.subscription_id }
    end
  ...
  test "should update invoiceitem" do
    put :update, id: @invoiceitem, invoiceitem: { amount: @invoiceitem.amount, description: @invoiceitem.description, invoice_id: @invoiceitem.invoice_id, subscription_id: @invoiceitem.subscription_id }
    assert_redirected_to invoiceitem_path(assigns(:invoiceitem))
  end
